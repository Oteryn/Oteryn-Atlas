...
function npc(hex, name, dx, dy, roles = [], { animated = false } = {}) {
  ...
  if (animated) record.outfit_presentation = Object.freeze({ outfit_presentation_id: 'outfit-presentation:qualification-guide' });
...
export const QUALIFICATION_CREATURES = Object.freeze([
  npc('1', 'Fixture Guide', 0, 0, ['shop', 'quest'], { animated: true }),
