...
function presentationId(hex) {
  return `outfit-presentation:sha256:${hex.repeat(64)}`;
}
function npc(hex, name, dx, dy, roles = [], { animated = false } = {}) {
  ...
  if (animated) record.outfit_presentation = Object.freeze({ outfit_presentation_id: presentationId(hex) });
...
export const QUALIFICATION_CREATURES = Object.freeze([
  ...
  npc('2', 'Fixture Wayfarer', 2, 0, ['travel', 'shop', 'quest', 'blessing', 'trainer'], { animated: true }),
  npc('3', 'Fixture Cartographer With A Deliberately Long Name', 4, 5, []),
