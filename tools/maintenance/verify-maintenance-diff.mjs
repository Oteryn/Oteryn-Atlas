...
function loadVerificationRestorationAuthority(base){
  ...
  if(raw.schemaVersion!==1||raw.programme!=='atlas-verification-restoration'||!['r1-r3','r1-r4','r1-r5'].includes(raw.phase)||!Array.isArray(raw.rules)||!raw.rules.length||raw.rules.length>108)fail('restoration allowlist identity is invalid');
