...
test('desktop Sam direct activation opens exact Gameplay shop, preserves Semantic, and round-trips URL state', async ({ page }, testInfo) => {
  ...
  await captureUserVisualEvidence(page, testInfo, 'desktop.creature-gameplay-real', {
    surfaceMetrics: gameplayMetrics,
    note: 'Desktop bounded-real compatibility for Sam Gameplay inspector with Game-owned trade data.',
  });
