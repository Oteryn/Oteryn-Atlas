...
test('desktop Atlas-owned chrome and user journey retain reviewed visual contracts', async ({ page }, testInfo) => {
  ...
  await expect(page.locator('#mobile-inspector-panel')).toHaveScreenshot((__atlasQualification ? ["protected-reference","desktop-inspector.png"] : 'desktop-inspector.png'), {
    animations: 'disabled', caret: 'hide', scale: 'css',
  });
