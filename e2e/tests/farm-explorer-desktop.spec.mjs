...
test('desktop Farm Explorer fails closed for upstream facts and keeps custom kill estimator usable', async ({ page }) => {
  ...
  await rat.click();
  await expect.poll(() => new URL(page.url()).searchParams.get('farmCreature')).toBe('monster-entity:80295e51265b3662bfbea2ea01ee3ccb');
  ...
  expect(reloaded.selectedCreatureId).toBe('monster-entity:80295e51265b3662bfbea2ea01ee3ccb');
